...
public class collegeDetails extends JFrame {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					collegeDetails frame = new collegeDetails("AAA", "College", "Description Here");
	 ...
	 * Create the frame.
	 */
	public collegeDetails(String abb, String name, String desc) {
		...
		JLabel lblNewLabel = new JLabel("EDIT COLLEGE");
