...
public class addnewcollege extends JFrame {
		...
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					...
					addnewcollege frame = new addnewcollege(parentDashboard);
	 ...
	 * Create the frame.
	 */
	public addnewcollege(dashboard parentDashboard) {
		...
		JLabel lblNewLabel = new JLabel("ADD NEW COLLEGE");
		...
		btnNewButton.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				try {
                    ...
                    String insertSql = "INSERT INTO college (abbreviation, name, description)" +
                            "VALUES (?, ?, ?)";
                 ...
                 // After successfully inserting data into the database
                    ...
                    parentDashboard.refreshCollegeTable();
                    dispose();
	...
	private boolean isNameExists(String name) throws SQLException {
	    Connection connection = dbConnection.getConnection();
	    String checkQuery = "SELECT name FROM college WHERE name = ?";
